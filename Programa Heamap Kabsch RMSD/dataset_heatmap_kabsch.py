...
def main():
	...
	for i in xrange(1,number_pathway+1): 
		path_pathways = '/home/bruna/teste/13FIBO/' # pasta do arquivo
		filename      = 'ABBABBABABBAB_pathwaystep3000_'+ str(i) +'_pathways.txt' # nome de cada pathway
		################################################################################################################################################################################
		path_save     = 'datasets/' # pasta de destino para salvar
	...
	# Se quiser remover algumas estruturas
	'''
	count = 0
	...
	# Salvar matriz de similaridade entre as estruturas finais
	...
	# Salvar matriz de similaridade entre as estruturas iniciais
	dataset_name   = filename[0:filename.find("_")]
